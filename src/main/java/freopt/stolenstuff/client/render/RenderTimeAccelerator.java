package freopt.stolenstuff.client.render;

import java.awt.Color;

import freopt.stolenstuff.client.render.magiccircles.ColorFunctions;
import freopt.stolenstuff.handler.RTEventHandler;
import freopt.stolenstuff.util.client.MKRRenderUtil;
import freopt.stolenstuff.util.client.RenderUtils;
import freopt.stolenstuff.client.render.magiccircles.IColorFunction;
