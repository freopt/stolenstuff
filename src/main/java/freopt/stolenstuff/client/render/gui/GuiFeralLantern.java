...
import freopt.stolenstuff.network.PacketSetFeralLanternLoS;
import freopt.stolenstuff.network.StolenStuffNetwork;
...
{
    private static final String TEXT_ENABLED_SHORT = "gui." + StolenStuff.MODID + ".feral_flare_lantern.state.los_on.short";
    private static final String TEXT_DISABLED_SHORT = "gui." + StolenStuff.MODID + ".feral_flare_lantern.state.los_off.short";
    private static final String TEXT_ENABLED_DESC = "gui." + StolenStuff.MODID + ".feral_flare_lantern.state.los_on.description";
    private static final String TEXT_DISABLED_DESC = "gui." + StolenStuff.MODID + ".feral_flare_lantern.state.los_off.description";
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        StolenStuffNetwork.getNetwork().sendToServer(new PacketSetFeralLanternLoS(!tile.shouldUseLineOfSight(), tile));
    }
